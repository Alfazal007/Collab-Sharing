...
export default function () {
    ...
    // zod implementation
    const form = useForm<z.infer<typeof postToCommunityType>>({
        resolver: zodResolver(postToCommunityType),
    });

    // TODO:: UPDATE THIS PART
    async function onSubmit(values: z.infer<typeof postToCommunityType>) {
        setIsSubmitting(true);
        try {
            const createPost = await axios.post(
                "/api/post/remove-from-community",
                values
            );
